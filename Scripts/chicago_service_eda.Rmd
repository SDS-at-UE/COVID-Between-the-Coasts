...
Choosing example variable (Need to run Dr. Weber's code first):
```{r}
...
chicago_sex_age_ex <- chicago_sex_age_2 %>%
  filter(variable == "B01001I_018") # female, 0-17 
  
chicago_sex_age_ex <- chicago_sex_age_ex %>%
  rename(prop_female = prop_sex,
         prop_0_17 = prop_age,
         prop_not_female_0_17 = prop_sex_age)
```
...
chicago_HI_ex <- chicago_HI_2 %>%
  filter(variable == "B27001_032") # female, under 6, yes

chicago_HI_ex <- chicago_HI_ex %>%
  rename(prop_female = prop_sex,
         prop_under_6 = prop_age,
         prop_with_HI = prop_HI_cov,
         prop_female_under_6 = prop_sex_age,
         prop_female_with_Hi = prop_sex_HI_cov,
         prop_under_6_with_HI = prop_age_HI_cov,
         prop_female_under_6_with_HI = prop_sex_age_HI_cov)
```
...
#Male, Non-Service Worker
chicago_sex_by_ind_pick <- chicago_sex_by_ind_2 %>% 
  filter(variable == "B24032_002")

chicago_sex_by_ind_pick <- chicago_sex_by_ind_pick %>%
  rename(prop_male = prop_sex,
         prop_non_service = prop_service,
         prop_male_non_service =  prop_sex_service)
```
