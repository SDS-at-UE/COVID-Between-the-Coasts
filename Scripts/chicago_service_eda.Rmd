...
What follows is an explanation for all of the variables in `chicago_master`. All populations are estimated, which in turns means proportions are estimated.
