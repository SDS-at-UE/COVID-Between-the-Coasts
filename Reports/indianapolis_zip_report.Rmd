...
ggplot(indy_income_six_figure_corr, aes(prop_100K, case_rate)) +
  ...
  labs(title = "Income Distribution of Each Indianapolis Zip Code",
    ...
    ggrepel::geom_label_repel(data = filter(indy_income_six_figure_corr, case_rate > .03),
                            aes(label = GEOID))
```
...
ggplot(indy_race_cor, aes(prop_black, case_rate)) +
  ...
  labs(title = "African American Proportion for Each Zip Code in Indianapolis",
       ...
       y = "Case Rate") +
  ggrepel::geom_label_repel(data = filter(indy_race_cor, case_rate > .03),
                            aes(label = GEOID))
```
...
ggplot(indy_citizen_cor, aes(prop_not_citizen,case_rate)) + 
  ...
  labs(title = "Non-Citizenship Proportion within Each Zip Code in Indianapolis",
       ...
       y = "Case Rate") +
  ggrepel::geom_label_repel(data = filter(indy_citizen_cor, case_rate > .03),
                            aes(label = GEOID))
```
...
ggplot(indy_trans_cor, aes(prop_public, case_rate)) +
  ...
  labs(title = "Transportation Proportion for Each Indianapolis Zip Code",
       ...
       x = "Proportion",
       y = "Case Rate") +
  ggrepel::geom_label_repel(data = filter(indy_trans_cor, case_rate > .03),
                            aes(label = GEOID))
```
...
ggplot(indy_gini_cor, aes(estimate, case_rate)) +
  ...
  labs(title = "Gini Index for Each Indianapolis Zip Code",
       ...
       x = "Gini Index",
       y = "Case Rate") +
  ggrepel::geom_label_repel(data = filter(indy_gini_cor, case_rate > .03),
                            aes(label = GEOID))
```
...
indy_hi_private_cor %>%
  ...
  labs(title = "Private HI vs Case Rate",
       ...
       x = "Proportion",
       y = "Case Rate") +
  ggrepel::geom_label_repel(data = filter(indy_hi_private_cor, case_rate > .03),
                            aes(label = GEOID))
```
