...
There is a low correlation of `r cor.test(chicago_age_cor_sans60604$prop_60, chicago_age_cor_sans60604$case_rate, use = "complete.obs")$estimate` between individuals over the age of 60 and COVID-19 case rates ($p=$`r cor.test(chicago_age_cor_sans60604$prop_60, chicago_age_cor_sans60604$case_rate, use = "complete.obs")$p.value`, which means our correlation is indistinguishable from 0).
