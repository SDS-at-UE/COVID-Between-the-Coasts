...
The coefficients indicate how influential each demographic is. For example: A 0.1 increase in the proportion of 18 to 34 year old Hispanic/Latinos will correspond to a decrease of 133 per 100,000 in the COVID case rate. Contrast this with the fact that a 0.1 increase in the proportion of Hispanic/Latinos (not necessarily 18 to 34) will correspond to an increase in the case rate of 255 per 100,000. It seems we have an almost 400 cases per 100,000 swing just by focusing on the 18 to 34 age range. Looking at a far less significant variable, the population that is Hispanic (note this was a positive correlation), a 0.1 increase in this population does not even increase the case rate by 1 person per 100,000. 
