...
After performing the ANOVA test, we see evidence to suggest that there is not a correlation with private health insurance and the COVID case rate. From the ANOVA test we got an insignificant p-value of 0.191 and a high R^2 value of 0.0582!In this case, as the proportion that have private health insurance increases, we see no change in the case rate.
