...
The purpose of this markdown is to post the latest COVID case numbers for the seven midwestern states as part of the COVID Between the Coasts reporting in partnership with WNIN and Que Pasa Midwest? It runs every day at 6:00 PM CT and grabs the latest information from [USAFacts.org](https://usafacts.org/visualizations/coronavirus-covid-19-spread-map). 
